...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.k, request.a_, true);
		} catch (e) {
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { bh: 'hidden', a5: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { bh: 'mozHidden', a5: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { bh: 'msHidden', a5: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { bh: 'webkitHidden', a5: 'webkitvisibilitychange' }
		: { bh: 'hidden', a5: 'visibilitychange' };
}
...
var author$project$Main$Issue = F3(
	function (number, title, state) {
		return {aC: number, aU: state, ai: title};
	});
...
var author$project$Main$Repo = F7(
	function (name, description, language, owner, fork, star, watch) {
		return {a8: description, bg: fork, bk: language, aA: name, aE: owner, bC: star, bJ: watch};
	});
...
var author$project$Main$repoDecoder = A8(
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{A: false, a3: r.a3, ar: r.ar, g: r.g, k: r.k, n: r.n, o: r.o, a_: r.a_}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{a3: elm$http$Http$emptyBody, ar: r.ar, g: _List_Nil, k: 'GET', n: elm$core$Maybe$Nothing, o: elm$core$Maybe$Nothing, a_: r.a_});
};
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {as: fragment, av: host, aF: path, aH: port_, aK: protocol, aL: query};
	});
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'#' + elm$core$String$fromInt(issue.aC))
					])),
				A2(
				elm$html$Html$span,
				_List_Nil,
...
var author$project$Main$main = elm$browser$Browser$application(
	{bj: author$project$Main$init, bu: author$project$Main$UrlChanged, bv: author$project$Main$LinkClicked, bE: author$project$Main$subscriptions, bH: author$project$Main$update, bI: author$project$Main$view});
