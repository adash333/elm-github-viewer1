...
{
	if (region.ae.J === region.ao.J)
	{
		return 'on line ' + region.ae.J;
	}
	return 'on lines ' + region.ae.J + ' through ' + region.ao.J;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.k, request.aV, true);
		} catch (e) {
...
var author$project$Main$Model = F2(
	function (key, page) {
		return {av: key, M: page};
	});
var author$project$Main$TopPage = {$: 1};
var author$project$GitHub$Issue = F3(
	function (number, title, state) {
		return {bq: number, bB: state, bG: title};
	});
...
var author$project$GitHub$issueDecoder = A4(
	elm$json$Json$Decode$map3,
	author$project$GitHub$Issue,
...
var author$project$GitHub$issuesDecoder = elm$json$Json$Decode$list(author$project$GitHub$issueDecoder);
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{A: false, a_: r.a_, aq: r.aq, g: r.g, k: r.k, n: r.n, o: r.o, aV: r.aV}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{a_: elm$http$Http$emptyBody, aq: r.aq, g: _List_Nil, k: 'GET', n: elm$core$Maybe$Nothing, o: elm$core$Maybe$Nothing, aV: r.aV});
};
...
var author$project$GitHub$getIssues = F3(
	function (toMsg, userName, projectName) {
		return elm$http$Http$get(
			{
				aq: A2(elm$http$Http$expectJson, toMsg, author$project$GitHub$issuesDecoder),
				aV: A3(
...
var author$project$GitHub$Repo = F7(
	function (name, description, language, owner, fork, star, watch) {
		return {a3: description, bb: fork, bf: language, bh: name, bv: owner, bA: star, bJ: watch};
	});
...
var author$project$GitHub$repoDecoder = A8(
	elm$json$Json$Decode$map7,
	author$project$GitHub$Repo,
	...
	A2(elm$json$Json$Decode$field, 'forks_count', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'stargazers_count', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'watchers_count', elm$json$Json$Decode$int));
var author$project$GitHub$reposDecoder = elm$json$Json$Decode$list(author$project$GitHub$repoDecoder);
var author$project$GitHub$getRepos = F2(
	function (toMsg, userName) {
		return elm$http$Http$get(
			{
				aq: A2(elm$http$Http$expectJson, toMsg, author$project$GitHub$reposDecoder),
				aV: A3(
					elm$url$Url$Builder$crossOrigin,
					'https://api.github.com',
					_List_fromArray(
			...
			switch (maybeRoute.a.$) {
				...
				case 1:
					...
					return _Utils_Tuple2(
						model,
						A2(
							author$project$GitHub$getRepos,
							A2(
				...
				default:
					...
					var userName = _n2.a;
					var projectName = _n2.b;
					return _Utils_Tuple2(
						model,
						A3(
							author$project$GitHub$getIssues,
							A2(
								elm$core$Basics$composeR,
...
var elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {w: frag, y: params, v: unvisited, r: value, z: visited};
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {ar: fragment, au: host, aB: path, aD: port_, aG: protocol, aH: query};
	});
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'#' + elm$core$String$fromInt(issue.bq))
					])),
				A2(
				elm$html$Html$span,
				_List_Nil,
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('My GitHub Viewer1')
											]))
									]))
							]))
					])),
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$text('Go To TopPage')
											]))
									]))
							]))
					])),
						...
						_List_fromArray(
							[
								...
								switch (_n0.$) {
									...
									case 2:
										var repos = _n0.a;
										return author$project$Main$viewUserPage(repos);
									default:
										var issues = _n0.a;
										return author$project$Main$viewRepoPage(issues);
								}
							}()
							]))
					])),
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Attributes$href('http://i-doctor.sakura.ne.jp/font/?p=38434')
											]),
										_List_fromArray(
											[
...
var author$project$Main$main = elm$browser$Browser$application(
	{be: author$project$Main$init, br: author$project$Main$UrlChanged, bs: author$project$Main$LinkClicked, bD: author$project$Main$subscriptions, bH: author$project$Main$update, bI: author$project$Main$view});
